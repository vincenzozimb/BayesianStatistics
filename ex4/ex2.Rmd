...
Jags is better, look at trace plot. However, similar results, even if not precisely. But both are wrong, sign of a wrong $k$ (not anymore)... 
Also gibbs sampler requires more samples to properly work, instead jags is optimized
