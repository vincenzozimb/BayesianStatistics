...
The distances between the two sets of parallel lines will be the norm of these vectors.  
...
The maximum distance between parallel lines is `r sprintf("dist1 = %f",d1)` for the first MCG, while it is `r sprintf("dist2 = %f",d2)` for the second.
