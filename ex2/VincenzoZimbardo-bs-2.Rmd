...
# plot
par(mfrow = c(1, 2))
plot(x,y, type="l", ylab="Posterior kernel")
hist(x_ar, main="")
```
```{r echo=FALSE}
...
w <- PosteriorKernel(theta) / PriorKernel(theta)
w <- w / length(w)
# Perform resampling
m <- 2000
...
# Confidence interval
print(paste0("Confidence interval of theta: [",round(alpha+qnorm(0.025)*sqrt(var),4), ", ", round(alpha+qnorm(0.975)*sqrt(var),4), "]"))
```
